  ...
  head: () => ({
    meta: [
      { title: "Contact Us | Labmed Technologies Pretoria" },
      {
        name: "description",
        content:
          "Contact Labmed Technologies in Akasia, Pretoria. Call 012 004 2837, WhatsApp 064 936 6549 or send an enquiry for laboratory, medical and agricultural supplies.",
      },
